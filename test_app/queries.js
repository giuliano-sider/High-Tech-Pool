...
module.exports = {
    ...
    dados_admin_login_attempt: (username, password) => 
    ...
    estado_raia: (id_piscina, numero_raia) =>
            'select estado ' +
            'from Raia ' +
            'where id_piscina = ' + "'" + id_piscina + "' " +
            '  and numero = ' + "'" + numero_raia + "';",

    cabecalho_tipo_treinamento: () => 
            'select * from Tipo_Treinamento;',

    sequencia_exercicios_em_tipo_treinamento: (id_tipo_treinamento) => 
